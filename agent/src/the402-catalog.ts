...
export const THE402_LISTINGS: ReadonlyArray<{
  ...
  },
  {
    ...
    description: "Rank GitHub bounty issues and compare two to ten public bounty candidates using the full evidence-linked due-diligence check, preserving partial failures and selecting the strongest non-AVOID option. Documentation: https://cristianmoroaica.github.io/bountyverdict/agents.html",
    price: "$0.40",
    agent_price: "$0.42",
