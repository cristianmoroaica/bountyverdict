...
test("frequent reporting skips semantic retrieval while full audits establish a drain", async () => {
  ...
  assert.match(distribution, /if \(reportOnly\) \{\s+discovery = previousReport\.discovery/);
